...
CUDA_DEVICE
inline
void IntegrateLeavingParcel(double Tenv, double prevTenv, double Tparcel, double prevTparcel, double Penv, double prevPenv, double Zenv, double prevZenv, double& out_CAPE, double& out_ELT, double& out_ELP)
{
	/*
...
double CalcCAPE1040(double Tenv, double prevTenv, double Tparcel, double prevTparcel, double Penv, double prevPenv, double Zenv, double prevZenv)
{
	...
	else if (prevTparcel >= prevTenv) 
	{
		...
		if (prevTenv >= coldColderLimit && prevTenv <= coldWarmerLimit)
		{
			...
			double CAPE, ELT, ELP;
			CAPE::IntegrateLeavingParcel(Tenv, prevTenv, Tparcel, prevTparcel, Penv, prevPenv, Zenv, prevZenv, CAPE, ELT, ELP);
			C = CAPE;
		}
	}
...
CUDA_DEVICE
inline
void CalcCAPE(double Tenv, double prevTenv, double Tparcel, double prevTparcel, double Penv, double prevPenv, double Zenv, double prevZenv, double& out_CAPE, double& out_ELT, double& out_ELP)
{
	out_CAPE = 0.;
	...
	{
		CAPE::IntegrateLeavingParcel(Tenv, prevTenv, Tparcel, prevTparcel, Penv, prevPenv, Zenv, prevZenv, out_CAPE, out_ELT, out_ELP);
	}
...
std::pair<std::vector<double>,std::vector<double>> Get500mMixingRatioTAndTDGPU(std::shared_ptr<const plugin_configuration> conf, std::shared_ptr<info> myTargetInfo);
...
void GetCAPEGPU(const std::shared_ptr<const plugin_configuration> conf, std::shared_ptr<info> myTargetInfo, const std::vector<double>& T, const std::vector<double>& P, himan::param ELTParam, himan::param ELPParam, himan::param CAPEParam, himan::param CAPE1040Param, himan::param CAPE3kmParam);
