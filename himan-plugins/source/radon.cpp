...
bool radon::SavePrevi(const info<double>& resultInfo)
{
	stringstream query;
...
bool radon::SaveGrid(const info<double>& resultInfo, const string& theFileName, const string& targetGeomName)
{
	stringstream query;
