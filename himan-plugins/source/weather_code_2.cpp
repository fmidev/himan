...
void weather_code_2::Calculate(shared_ptr<info> myTargetInfo, unsigned short theThreadIndex)
{
	...
	auto myThreadedLogger = logger_factory::Instance()->GetLog("weather_code_2Thread #" + boost::lexical_cast<string> (theThreadIndex));
	...
	LOCKSTEP(myTargetInfo,CloudInfo,PrecformInfo,TotalPrecInfo,TotalCloudCoverInfo,LowCloudCoverInfo,MedCloudCoverInfo,HighCloudCoverInfo,FogInfo,T0mInfo,T850Info,KInfo)
	{
