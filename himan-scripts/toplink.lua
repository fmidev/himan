...
function Product1()
  ...
  local visdata = luatool:Fetch(current_time, lvl, vis, current_forecast_type)
  local rrdata = luatool:Fetch(current_time, lvl, rr, current_forecast_type)
  local ptypedata = luatool:Fetch(current_time, lvl, ptype, current_forecast_type)
...
function Product2()
  ...
  local rrdata = luatool:Fetch(current_time, lvl, rr, current_forecast_type)
  local ptypedata = luatool:Fetch(current_time, lvl, ptype, current_forecast_type)
  local ceildata = luatool:Fetch(current_time, lvl, ceil, current_forecast_type)
