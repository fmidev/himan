...
local RH300 = luatool:FetchWithType(current_time, level(HPLevelType.kPressure, 300), param("RH-PRCNT"), current_forecast_type)
local RH500 = luatool:FetchWithType(current_time, level(HPLevelType.kPressure, 500), param("RH-PRCNT"), current_forecast_type)
local RH700 = luatool:FetchWithType(current_time, level(HPLevelType.kPressure, 700), param("RH-PRCNT"), current_forecast_type)
local RH850 = luatool:FetchWithType(current_time, level(HPLevelType.kPressure, 850), param("RH-PRCNT"), current_forecast_type)
local RH925 = luatool:FetchWithType(current_time, level(HPLevelType.kPressure, 925), param("RH-PRCNT"), current_forecast_type)
...
local PRET = luatool:FetchWithType(current_time, level(HPLevelType.kHeight, 0), param("PRECFORM2-N"), current_forecast_type)
