...
local rr = luatool:Fetch(current_time, current_level, par1, current_forecast_type)
local gr = luatool:Fetch(current_time, current_level, par2, current_forecast_type)
local sn = luatool:Fetch(current_time, current_level, par3, current_forecast_type)
