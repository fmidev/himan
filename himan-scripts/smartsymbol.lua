...
function CreateLookupTable()
  ...
  Generate({1,1},{0,6},{0,2},{0,7},{0,3},{0,5},{0,7},11000000,61)

  -- Scattered thundershowers
  Generate({1,1},{0,6},{0,2},{0,7},{0,3},{6,7},{0,7},11000060,63)

  -- Thundershowers
  Generate({1,1},{0,6},{0,2},{0,7},{0,3},{8,8},{0,7},11000080,63)

  -- Isolated showers
  Generate({0,0},{1,1},{2,2},{1,7},{0,3},{0,5},{0,7},10121000,21)

  -- Scattered showers
  Generate({0,0},{1,1},{2,2},{1,7},{0,3},{6,7},{0,7},10121060,31)

  -- Showers
  Generate({0,0},{1,1},{2,2},{1,7},{0,3},{8,8},{0,7},10121080,31)

  -- Freezing drizzle
  Generate({0,0},{4,4},{0,2},{1,7},{0,3},{0,8},{0,7},10401000,31)

  -- Freezing rain
  Generate({0,0},{5,5},{0,2},{1,7},{0,3},{0,8},{0,7},10501000,31)

  -- Drizzle
  Generate({0,0},{0,0},{0,2},{1,7},{0,3},{0,8},{0,7},10001000,31)

  -- Periods of light rain
  Generate({0,0},{1,1},{1,1},{1,2},{0,3},{0,5},{0,7},10111000,21)

  -- Periods of light rain
  Generate({0,0},{1,1},{1,1},{1,2},{0,3},{6,7},{0,7},10111060,31)

  -- Light rain
  Generate({0,0},{1,1},{1,1},{1,2},{0,3},{8,8},{0,7},10111080,31)

  -- Periods of moderate rain
  Generate({0,0},{1,1},{1,1},{3,5},{0,3},{0,5},{0,7},10113000,22)

  -- Periods of moderate rain
  Generate({0,0},{1,1},{1,1},{3,5},{0,3},{6,7},{0,7},10113060,32)

  -- Moderate rain
  Generate({0,0},{1,1},{1,1},{3,5},{0,3},{8,8},{0,7},10113080,32)

  -- Periods of heavy rain
  Generate({0,0},{1,1},{1,1},{6,7},{0,3},{0,5},{0,7},10116000,23)

  -- Periods of heavy rain
  Generate({0,0},{1,1},{1,1},{6,7},{0,3},{6,7},{0,7},10116060,33)

  -- Heavy rain
  Generate({0,0},{1,1},{1,1},{6,7},{0,3},{8,8},{0,7},10116080,33)

  -- Isolated light sleet showers
  Generate({0,0},{2,2},{0,2},{1,2},{0,3},{0,5},{0,7},10201000,71)

  -- Scattered light sleet showers
  Generate({0,0},{2,2},{0,2},{1,2},{0,3},{6,7},{0,7},10201060,81)

  -- Light sleet
  Generate({0,0},{2,2},{0,2},{1,2},{0,3},{8,8},{0,7},10201080,81)

  -- Isolated moderate sleet showers
  Generate({0,0},{2,2},{0,2},{3,3},{0,3},{0,5},{0,7},10203000,72)

  -- Scattered moderate sleet showers
  Generate({0,0},{2,2},{0,2},{3,3},{0,3},{6,7},{0,7},10203060,82)

  -- Moderate sleet
  Generate({0,0},{2,2},{0,2},{3,3},{0,3},{8,8},{0,7},10203080,82)

  -- Isolated heavy sleet showers
  Generate({0,0},{2,2},{0,2},{4,7},{0,3},{0,5},{0,7},10204000,72)

  -- Scattered heavy sleet showers
  Generate({0,0},{2,2},{0,2},{4,7},{0,3},{6,7},{0,7},10204060,83)

  -- Heavy sleet
  Generate({0,0},{2,2},{0,2},{4,7},{0,3},{8,8},{0,7},10204080,83)

  -- Isolated light snow showers
  Generate({0,0},{3,3},{0,2},{1,2},{0,3},{0,5},{0,7},10301000,41)

  -- Scattered light snow showers
  Generate({0,0},{3,3},{0,2},{1,2},{0,3},{6,7},{0,7},10301060,51)

  -- Light snowfall
  Generate({0,0},{3,3},{0,2},{1,2},{0,3},{8,8},{0,7},10301080,51)

  -- Isolated moderate snow showers
  Generate({0,0},{3,3},{0,2},{3,3},{0,3},{0,5},{0,7},10303000,42)

  -- Scattered moderate snow showers
  Generate({0,0},{3,3},{0,2},{3,3},{0,3},{6,7},{0,7},10303060,52)

  -- Moderate snowfall
  Generate({0,0},{3,3},{0,2},{3,3},{0,3},{8,8},{0,7},10303080,52)

  -- Isolated heavy snow showers
  Generate({0,0},{3,3},{0,2},{4,7},{0,3},{0,5},{0,7},10304000,43)

  -- Scattered heavy snow showers
  Generate({0,0},{3,3},{0,2},{4,7},{0,3},{6,7},{0,7},10304060,53)

  -- Heavy snowfall
  Generate({0,0},{3,3},{0,2},{4,7},{0,3},{8,8},{0,7},10304080,53)
