...
class stereographic_grid : public grid
{
	public:
		stereographic_grid();
		stereographic_grid(HPScanningMode theScanningMode, point theBottomLeft, point theTopRight, double theOrientation = kHPMissingValue);
...
inline
std::ostream& operator<<(std::ostream& file, const stereographic_grid& ob)
{
